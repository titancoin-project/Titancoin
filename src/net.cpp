...
static const char *strMainNetDNSSeed[][2] = {
    {"mainnet.titancoin.org", "seed.titancoin.org"},
    {"karen.titancoin.org", "seedka.titancoin.org"},
    {"darrel.titancoin.net", "seedda.titancoin.net"},
    {"housen.titancoin.net", "seedho.titancoin.net"},
    {"armen.titancoin.info", "seedar.titancoin.info"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"testnet.titancoin.org", "seedtest.titancoin.org"},
    {"testnet2.titancoin.net", "seedtest2.titancoin.net"},
    {NULL, NULL}
};
