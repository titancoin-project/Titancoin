...
std::string HelpMessage()
{
    string strUsage = _("Options:") + "\n" +
        ...
        "  -port=<port>           " + _("Listen for connections on <port> (default: 8875 or testnet: 8975)") + "\n" +
        ...
        "  -rpcport=<port>        " + _("Listen for JSON-RPC connections on <port> (default: 8874 or testnet: 8974)") + "\n" +
        ...
        "\n" + _("SSL options: (see the Titancoin Wiki for SSL setup instructions)") + "\n" +
